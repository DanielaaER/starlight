...
const TrackingPedido = () => {
  const productData = {
    ...
    status: 'En camino',
    timelineData: [
      { id: 1, title: 'Pedido Recibido' },
      { id: 2, title: 'Producto Enviado' },
      { id: 3, title: 'Producto En Camino' },
      { id: 4, title: 'Producto Recibido' }
    ],
        ...
        <div className="refund-summary">
          ...
          <div className="refund-details">
            <div className="refund-details-item">
              <div className="refund-details-description">Gestión de la devolución</div>
            </div>
            <div className="refund-details-item">
              <div className="refund-details-title">Ver detalles del pedido</div>
            </div>
            <div className="refund-details-item">
              <div className="refund-details-description">Escribir reseña del producto</div>
            </div>
          </div>
          <button className="continue-shopping-button" >Seguir comprando</button>
        </div>
