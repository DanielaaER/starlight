...
const Header = () => (
    <View style={styles.header}>
        <Text>starlight.com - Centro de Deseos                                                                             https://starlight.com/account/devolucion/ed4eeab3-d08b-4339-96</Text>
    </View>
);



const ShippingLabel = (name) => (
    <View style={styles.shippingLabel}>
        ...
        <View style={{ flexDirection: 'row' }}>
            <View style={{ flex: 1 }}>
                ...
                <Text style={styles.subtitle}>Lista de Deseos: {name}</Text>
